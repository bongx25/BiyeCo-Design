  ...
  return (
    <div className="relative flex flex-row justify-start items-center gap-[clamp(0.5rem,2vw,2rem)] w-full mb-[clamp(0.8rem,2vh,1.5rem)] mt-0 pt-0 pb-2 pr-2 pl-0 lg:pt-0 lg:pb-4 lg:pr-4 rounded-xl">
      ...
      <motion.div
        ...
        className={`relative w-[clamp(90px,42%,240px)] cursor-pointer transition-all duration-300 flex items-center justify-center origin-left ${
          selectedRole === 'groom' ? 'scale-110 z-10' : 'scale-100 opacity-60 hover:opacity-90 z-0'
        }`}
      ...
      <motion.div
        ...
        className={`relative w-[clamp(90px,42%,240px)] cursor-pointer transition-all duration-300 flex items-center justify-center origin-left ${
          selectedRole === 'bride' ? 'scale-110 z-10' : 'scale-100 opacity-60 hover:opacity-90 z-0'
        }`}
